...
rho, rho0, rho1, rho2, rho01, rho02, rho_inf, rho_star = symbols(
    "rho rho0:3 rho01 rho02 rho_inf rho*"
)
T, T0, T1, T2, T01, T02, T_inf, T_star = symbols("T T0:3 T01 T02 T_inf T*")

p0_p, p0_p_inf, p0_p_star, p2_p1, p01_p1, p02_p2, p02_p1, p02_p01 = symbols(
    "p0/p p0/p_inf p0/p* p2/p1 p01/p1 p02/p2 p02/p1 p02/p01"
)
rho0_rho, rho0_rho_inf, rho0_rho_star, rho2_rho1, rho01_rho1, rho02_rho2 = symbols(
    "rho0/rho rho0/rho_inf rho0/rho* rho2/rho1 rho01/rho1 rho02/rho2"
)
T0_T, T0_T_inf, T0_T_star, T2_T1, T01_T1, T02_T2 = symbols(
    "T0/T T0/T_inf T0/T* T2/T1 T01/T1 T02/T2"
)
u2_u1 = symbols("u2/u1")
