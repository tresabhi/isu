...
A = Symbol("A", "m^2", "Area")
A_A_star = Symbol("A_sub/A*", None, "Area (generic / critical)")
...
M = Symbol("M", None, "Mach number (generic)", initial=EPSILON)
...
p = Symbol("p", "Pa", "Pressure (generic)")
p0_p = Symbol("p0/p", None, "Pressure ratio (stagnant / generic)")
p_p0 = Symbol("p/p0", None, "Pressure ratio (generic / stagnant)")
...
T = Symbol("T", "K", "Temperature (generic)")
T0_T = Symbol("T0/T", None, "Temperature ratio (stagnant / generic)")
