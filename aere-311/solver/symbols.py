...
u3 = S("u3", "m / s", "Velocity (3)")
u2_u1 = S("u2/u1", None, "Velocity (2/1)")
u3_u1 = S("u3/u1", None, "Velocity (3/1)")
...
p03_p3 = S("p03/p3", None, "Pressure ratio (stagnant 3 / 3)")
...
rho3_rho1 = S("rho3/rho_1", None, "Density ratio (3 / 1)")
...
rho03_rho3 = S("rho03/rho3", None, "Density ratio (stagnant 3 / 3)")
...
T3_T1 = S("T3/T1", None, "Temperature ratio (3 / 1)")
...
T03_T3 = S("T03/T3", None, "Temperature ratio (stagnant 3 / 3)")
...
mu1 = S("mu1", "radian", "Mach line (forward)")
mu2 = S("mu2", "radian", "Mach line (rearward)")
theta = S("theta", "radian", "Angle (generic)")
theta2 = S("theta2", "radian", "Angle (top)")
theta3 = S("theta2", "radian", "Angle (bottom)")
...
w3 = S("w3", "m / s", "Wave tangential velocity (3)")
