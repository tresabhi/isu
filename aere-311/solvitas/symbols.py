...
At2_At1 = Symbol("At2/At1", None, "Area ratio (throat 2 / throat 1)")
At1 = Symbol("At1", "m^2", "Area (throat 1)")
At2 = Symbol("At2", "m^2", "Area (throat 2)")
At = Symbol("At", "m^2", "Area (throat)")
...
# M_sub = Symbol("M_sub", None, "Mach number (generic)", initial=(EPSILON, 2)) TODO: EXPERIEMNT WITH TUPLE GUESSES
...
p01_p02 = Symbol("p01/p02", None, "Pressure ratio (stagnant 1 / stagnant 2)")
